...
IMPORT INTO artists (constituent_id, display_name, nationality) CSV DATA ('nodelocal://1/artists.csv') WITH nullif = '';
IMPORT INTO artworks (title, artist, date, accession_number) CSV DATA ('nodelocal://1/artworks.csv') WITH nullif = '';
