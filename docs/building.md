...
```
and then following the same steps for using your custom image as in that engine's README ([PostgreSQL](../postgres/README.md#usage), [MySQL](../mysql/README.md#usage), [CockroachDB](../cockroach/README.md#usage), [SQLite](../sqlite/README.md#usage), [DuckDB](../duckdb/README.md#usage), [ClickHouse](../clickhouse/README.md#usage), [Apache Druid](../druid/README.md#usage), [Apache Pinot](../pinot/README.md#usage)).
