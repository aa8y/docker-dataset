...
| `airlines` (PostgreSQL) | [postgrespro demo database](https://postgrespro.com/community/demodb) | MIT *(verified 2026-08-09)* | Postgres Professional's flight-bookings demo database. | Pinned — snapshot `demo-20250901-3m`. If postgrespro retires the file the URL needs bumping. |
